...
const Header = () => {
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      <div data-aos="fade-right" class="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
        <h2 class="text-sm title-font text-gray-500 tracking-widest">Hello!</h2>
        <h1 class=" typewriter text-white text-4xl title-font font-medium mb-4">I'M Krishna Prasad</h1>
...
            </a>
      ...
      <img data-aos="fade-left" alt="ecommerce" class=" rounded-5 lg:w-2/5 w-30 lg:h-1/2 h-64 object-cover object-center rounded" src={me}/>
